                ...
                <div class="cart">
                    <table class="table table-responsive">
                        ...
                        <tr>
                            ...
                            <td><?php echo $arr_cart_p_current_price[$i]; ?> FCFA</td>
                            ...
                            <td class="text-right">
                                ...
                                ?>
                                <?php echo $row_total_price; ?> FCFA
                            </td>
                        </tr>
                        <?php endfor; ?>           
                        <tr>
                            <th colspan="7" class="total-text"><?php echo LANG_VALUE_81; ?></th>
                            <th class="total-amount"><?php echo $table_total_price; ?> FCFA</th>
                        </tr>
                        <?php
                        ...
                        <tr>
                            ...
                            <td class="total-amount"><?php echo $shipping_cost; ?> FCFA</td>
                        </tr>
                        <tr>
