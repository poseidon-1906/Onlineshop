...
if(isset($_POST['form_contact']))
{
    ...
    {
        $valid = 0;
        $error_message .= 'Entrez votre nom.\n';
    }

    if(empty($_POST['visitor_phone']))
    {
        $valid = 0;
        $error_message .= 'Entrez votre numero de tel.\n';
    }
    ...
    {
        $valid = 0;
        $error_message .= 'Entrez votre addresse email.\n';
    }
    else
    {
        ...
        {
            $valid = 0;
            $error_message .= 'Entrez une addresse email valide.\n';
        }
    }
    ...
    {
        $valid = 0;
        $error_message .= 'Entrez votre message.\n';
    }
...
?>
                ...
                ?>
                    ...
                    <div class="col-md-4">
                        <legend><span class="glyphicon glyphicon-globe"></span> Notre Boutique</legend>
                        <address>
