...
<h1 class ="h1">La Qualité Accéssible à Tous !!! </h1>
<div class="someDesc">
    <img src="assets/img/001396727_896x598_c-removebg.png" alt="" width = "55%" height = "auto">
    <div class="DescText">
        <h3>Découvrez Notre Iphone 14 en Stock</h3>
        <p>
        L'iPhone 14 est bien plus qu'un simple smartphone. Son design élégant et robuste en fait un objet du quotidien. Profitez d'une expérience immersive grâce à son écran Super Retina XDR et d'une autonomie accrue pour tenir toute la journée...
        </p>
        <p><a href="product.php">Actuellement Disponible</a></p>
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <h4>
                                    <?php echo $row['p_current_price']; ?> XAF
                                    <?php if($row['p_old_price'] != ''): ?>
                                    
                                        <?php echo $row['p_old_price']; ?>XAF
...
<div class = "container1 contain2">
<h1 class ="h1">Nos Offres Spéciales </h1>
<div class="someDesc contain2">
    <img src="assets/img/S24_ultra.webp" alt="" width = "40%" height = "auto">
    <div class="DescText">
        <h3>Restez A La Pointe De La Technologie</h3>
        <p>
        "Le Samsung Galaxy S24 Ultra est le choix idéal pour ceux qui recherchent un smartphone performant avec fonctionalité optimal. Son grand écran Infinity-V vous offre une expérience visuelle immersive, tandis que sa batterie haute capacité vous permet de rester connecté toute la journée...
        </p>
        <p><a href="product.php">Ultra Performant</a></p>
...
<div class = "container1 contain">
<h1 class ="h1">Notre Vue D'ensemble </h1>
<div class="someDesc">
    <img src="assets/img/pexels-mediamodifier-61455177-8066712.jpg" alt="" width = "50%" height = "auto">
    <div class="DescText">
        <h3>Smart!! Smart!! Et Toujours Smart</h3>
        <p>
        En embrassant la puissance de la technologie, nous avons l’opportunité de bâtir un monde plus connecté, équitable et durable. Les défis sont nombreux, mais avec l'innovation et la collaboration, nous pouvons transformer ces défis en opportunités. <span> Alors tu passe chercher ton smartphone quand...!?</span>
        </p>
        <p><a href="product.php">A Bientôt 😎</a></p>
