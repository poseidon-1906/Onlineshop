...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 06, 2024 at 06:56 PM
...
(77, 'GOOGLE PIXEL 7 PRO', '', '100', 10, 'product-featured-77.jpg', '<div><font color=\"#0a0a0a\" face=\"opensans, Helvetica Neue, Helvetica, Helvetica, Arial, sans-serif\">Capturez des photos dignes d\'un professionnel avec le Google Pixel 7 Pro. Son système à trois objectifs vous permet de réaliser des clichés époustouflants, même dans des conditions de faible luminosité. De plus, la puce Tensor G2 offre des performances fluides pour toutes vos tâches quotidiennes.<br></font></div>', 'Pixel 7 Pro : Photo, vidéo, intelligence artificielle : le Pixel 7 Pro repousse les limites de la téléphonie.', '', '', '<p><br></p>', 7, 1, 1, 27),
...
(1, 'slider-1.jpg', 'Bienvenue Chez MrStoreShop', ' Découvrez notre large gamme de smartphones, des derniers modèles aux meilleures occasions. Nous proposons également des accessoires de qualité pour personnaliser votre appareil.', 'IPHONE SAMSUNG', '#', 'Center'),
