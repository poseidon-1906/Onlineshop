...
if(isset($_POST['form1'])) {
    ...
    if($path!='') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
            $valid = 0;
            $error_message .= 'Vous devez ajouter jpg, jpeg, gif or png file<br>';
        }
    } else {
    	$valid = 0;
        $error_message .= 'Vous devez selectioner une photo<br>';
    }
	...
	if($valid == 1) {
		...
		$success_message = 'Slider ajoutée!';
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="slider.php" class="btn btn-primary btn-sm">Voir Plus</a>
	</div>
</section>
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-9" style="padding-top:5px">
								<input type="file" name="photo">(Format jpg, jpeg, gif authorisé)
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Entête </label>
							<div class="col-sm-6">
