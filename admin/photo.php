...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="photo-add.php" class="btn btn-primary btn-sm">Ajouter</a>
	</div>
</section>
            	...
            	foreach ($result as $row) {
	                ...
	                <tr>
	                    ...
	                    <td>
	                        ...
	                        <a href="#" class="btn btn-danger btn-xs" data-href="photo-delete.php?id=<?php echo $row['id']; ?>" data-toggle="modal" data-target="#confirm-delete">Effacer</a>
	                    </td>
	                </tr>
	                <?php
            	}
