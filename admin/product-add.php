...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_id'])) {
        $valid = 0;
        $error_message .= "Vous devez selectionner un niveau Categorie Sup<br>";
    }

    if(empty($_POST['mcat_id'])) {
        $valid = 0;
        $error_message .= "Vous devez selectionner un niveau Categorie Mid<br>";
    }

    if(empty($_POST['ecat_id'])) {
        $valid = 0;
        $error_message .= "Vous devez selectionner un niveau Categorie Bas<br>";
    }

    if(empty($_POST['p_name'])) {
        $valid = 0;
        $error_message .= "Ce champs ne peut pas être vide<br>";
    }
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="product.php" class="btn btn-primary btn-sm">Voir Plus</a>
	</div>
</section>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="ecat_id" class="form-control select2 end-cat">
									<option value="">Selectionner End Level Category</option>
								</select>
							</div>                      
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Prix Occassion<br><span style="font-size:10px;font-weight:normal;">(In FCFA)</span></label>
							<div class="col-sm-4">
								<input type="text" name="p_old_price" class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Prix Actuel <span>*</span><br><span style="font-size:10px;font-weight:normal;">(In FCFA)</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Selectioner la Couleur</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Petite Description</label>
							<div class="col-sm-8">
