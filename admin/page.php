...
if(isset($_POST['form_about'])) {
    ...
    if(empty($_POST['about_title'])) {
        $valid = 0;
        $error_message .= 'Le Titre ne doit pas être vide<br>';
    }

    if(empty($_POST['about_content'])) {
        $valid = 0;
        $error_message .= 'Ne doit pas être vide<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Modification Terminée.';
...
if(isset($_POST['form_faq'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Page FAQ  mit à jour!.';
...
if(isset($_POST['form_contact'])) {
    ...
    if(empty($_POST['contact_title'])) {
        $valid = 0;
        $error_message .= 'TLe Titre ne doit pas être vide<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Page Contact  Mit à jour.';
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Titre de Page * </label>
                                        <div class="col-sm-5">
                                            <input class="form-control" type="text" name="about_title" value="<?php echo $about_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Contenu de Page  * </label>
                                        <div class="col-sm-8">
