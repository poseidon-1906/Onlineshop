        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-striped">
			<thead>
			    <tr>
			        <th>SL</th>
			        <th>Nom Mid Category </th>
                    <th>Nom Sup Category</th>
			        <th>Action</th>
			    </tr>
			</thead>
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr>
	                    ...
	                    <td>
	                        ...
	                        <a href="#" class="btn btn-danger btn-xs" data-href="mid-category-delete.php?id=<?php echo $row['mcat_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Effacer</a>
	                    </td>
	                </tr>
            		<?php
            	}
