...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="photo.php" class="btn btn-primary btn-sm">Voir plus</a>
	</div>
</section>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
				            <label for="" class="col-sm-2 control-label">Ancienne Photo</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Charger une Photo <span>*</span></label>
